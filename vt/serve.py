...
logger("The serve functionality is not stable yet. Use with caution!\n", 1)

if not os.path.isdir(__public_dir__):
    print_error(f"""[VT:WARNING]: Static directory '{__public_dir__}' does not \
exist. Add the directory for your app to serve static content\n""")
